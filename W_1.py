...
3. Sends a GET request to the API and checks if the response is correct.
...
URL = 'https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/Polska%20Gocza%C5%82kowice%20Zdr%C3%B3j?unitGroup=metric&include=hours&key=ZGDXV9ZMHP5GK77U9ZFM7JXSE&contentType=json'
OUTPUT_DIR = './data_weather'  
OUTPUT_FILENAME = os.path.join(OUTPUT_DIR, 'visualcrossing.json')
